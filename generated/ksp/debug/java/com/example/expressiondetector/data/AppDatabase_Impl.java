  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `detections` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `expression` TEXT NOT NULL, `confidence` REAL NOT NULL, `timestamp` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '21be4f92e092edfd0b9b64a8ae1c391a')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsDetections = new HashMap<String, TableInfo.Column>(4);
        _columnsDetections.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsDetections.put("expression", new TableInfo.Column("expression", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoDetections.equals(_existingDetections)) {
          return new RoomOpenHelper.ValidationResult(false, "detections(com.example.expressiondetector.data.DetectionEntity).\n"
                  + " Expected:\n" + _infoDetections + "\n"
                  + " Found:\n" + _existingDetections);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "21be4f92e092edfd0b9b64a8ae1c391a", "7c4d94e5f09b6b78409f9b0e486eb29d");
